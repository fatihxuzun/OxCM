...
![logo](https://raw.githubusercontent.com/fffatttihhh/OxCM/main/OxCM_logo.tif)
...
Use the package manager [pip](https://pip.pypa.io/en/stable/) to install latest version click:
